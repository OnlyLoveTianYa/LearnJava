...
//        boolean oneMedian = (nums1.length + nums2.length) % 2 == 1;
//
...
//
//        if (nums1.length == 0) {
//            return oneMedian ? nums2[medianIndex - 1]
//                    : (nums2[medianIndex - 2] + nums2[medianIndex - 1]) / 2;
//        }
//
//        if (nums2.length == 0) {
//            return oneMedian ? nums1[medianIndex - 1]
//                    : (nums1[medianIndex - 2] + nums1[medianIndex - 1]) / 2;
//        }
//
//        if (nums1[nums1.length - 1] < nums1[0]) {
//            return oneMedian ? nums2[medianIndex - nums1.length - 1]
//                    : (nums2[medianIndex - nums1.length - 2] + nums2[medianIndex - nums1.length - 1]) / 2;
//        }
//
//        if (nums2[nums2.length - 1] < nums1[0]) {
//            return oneMedian ? nums1[medianIndex - nums2.length - 1]
//                    : (nums1[medianIndex - nums2.length - 2] + nums1[medianIndex - nums2.length - 1]) / 2;
//        }
//
//        int nums1Index = 0;
//        int nums2Index = 0;
...
//        }
//        if (oneMedian) {
//            return nums1[nums1Index] < nums2[nums2Index] ? nums1[nums1Index] : nums2[nums2Index];
//        }
